...
<body>
    <div class="container">
        <div class="center">
            ...
            <a href="bulk-add.php">Add Entries in bulk</a>
        </div>
        ...
        <div class="center">
            <button type="button" class="btn btn-outline-primary my-1" title="Add New Category" id="addnewcat">Add New
                Category</button>
        ...
        <?php include("new.php"); ?>
        <input autofocus="" type="search" class="form-control" name="inputID" id="inputID"
            placeholder="Or Search Anything" autocomplete="off">

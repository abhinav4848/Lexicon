            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    ...
                    if (array_key_exists('category', $_GET)) {
                        echo '<a class="nav-link" href="view.php?category='.$_GET['category'].'" role="button">Go Back</a>';
                    } else {
                        echo '<a href="./" class="nav-link">Go back</a>';
                    }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="detailsModalLabel"><?= htmlspecialchars($row['heading'], ENT_QUOTES); ?>
                    </h5>

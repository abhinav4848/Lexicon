...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
		<a class="navbar-brand" href="index.php" title="Choose another category">Lexicon-<?= '<span class="phoneHeader">'.tokenTruncate($mbbs_categories['name'], 18).'</span><span class="normalHeader">'.$mbbs_categories['name'].'</span>'; ?></a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<button type="button" id="showHideAddnew" class="btn btn-outline-primary mr-2" title="Add New Entries">Add New 
				<?php 
	...
	<div class="container-fluid" id="top">
		...
		?>
		<input autofocus="" type="search" id="myInput" class="form-control mb-2" placeholder="Search from <?= $r[0]; ?> entries" title="Type in something">
